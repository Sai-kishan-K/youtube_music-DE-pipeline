...
# ----- Local File Path -----
LOCAL_TEMP_PATH = os.getenv("LOCAL_TEMP_PATH", "/tmp/youtube_music_raw.json")
...
with DAG(
    "youtube_minio_to_snowflake_bronze",
    default_args=default_args,
    description="Load raw Youtube music events from MinIO to Snowflake Bronze table",
